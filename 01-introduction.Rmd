...
A guess becomes a forecast if it relies on knowledge. Otherwise, it may as well be a gamble. We make a forecast if we guess rain for tomorrow because we observed clouds today. Here we account for our understanding of meteorological phenomena. We gamble if we make a guess of heads after the next flip of a coin because we observed tails after the current flip. We have not acquired any useful knowledge by observing the outcome of the current flip. 
