...
<!-- Figure~\ref{c1:series} illustrates this.  -->
<!-- \begin{figure}[htbp] -->
<!-- 	\includegraphics[width=1.0\textwidth]{figures/c1/dot_hist.eps} -->
<!-- 	\caption{Time series and its density} -->
<!-- 	\label{c1:series} -->
<!-- \end{figure} -->
