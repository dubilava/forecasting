...
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(dt,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x,}\DataTypeTok{y=}\NormalTok{y))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{color=}\StringTok{"goldenrod"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{,}\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{~}\NormalTok{x,}\DataTypeTok{se=}\NormalTok{F,}\DataTypeTok{color=}\StringTok{"darkgray"}\NormalTok{)}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{color=}\StringTok{"white"}\NormalTok{,}\DataTypeTok{fill=}\StringTok{"goldenrod"}\NormalTok{,}\DataTypeTok{binwidth=}\NormalTok{.}\DecValTok{5}\NormalTok{)}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{color=}\StringTok{"goldenrod"}\NormalTok{)}\OperatorTok{+}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{e <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{200}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{x <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{),}\DecValTok{200}\NormalTok{,}\DataTypeTok{replace=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y <-}\StringTok{ }\DecValTok{2}\FloatTok{+0.5}\OperatorTok{*}\NormalTok{x}\OperatorTok{+}\NormalTok{e}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{e <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{2}\NormalTok{)}

\KeywordTok{set.seed}\NormalTok{(}\DecValTok{4}\NormalTok{)}
\NormalTok{x <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{),}\DecValTok{100}\NormalTok{,}\DataTypeTok{replace=}\NormalTok{T)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y_f1 <-}\StringTok{ }\NormalTok{ols}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{ols}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{100}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{e_f1 <-}\StringTok{ }\NormalTok{y}\OperatorTok{-}\NormalTok{y_f1}

\NormalTok{mafe1 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(}\KeywordTok{abs}\NormalTok{(e_f1))}
\NormalTok{rmsfe1 <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(e_f1}\OperatorTok{^}\DecValTok{2}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y_f0 <-}\StringTok{ }\NormalTok{ols}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{ols}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{e_f0 <-}\StringTok{ }\NormalTok{y}\OperatorTok{-}\NormalTok{y_f0}

\NormalTok{mafe0 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(}\KeywordTok{abs}\NormalTok{(e_f0))}
\NormalTok{rmsfe0 <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(e_f0}\OperatorTok{^}\DecValTok{2}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n <-}\StringTok{ }\DecValTok{120}

\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{e <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n)}

\NormalTok{y <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{,n)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt <-}\StringTok{ }\KeywordTok{data.table}\NormalTok{(y,e)}

\NormalTok{dt}\OperatorTok{$}\NormalTok{date <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2011-01-01"}\NormalTok{),}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-12-01"}\NormalTok{),}\DataTypeTok{by=}\StringTok{"month"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Year"}\NormalTok{,}\DataTypeTok{y=}\StringTok{"Random Walk"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt}\OperatorTok{$}\NormalTok{average <-}\StringTok{ }\OtherTok{NA}
\NormalTok{dt}\OperatorTok{$}\NormalTok{naive <-}\StringTok{ }\OtherTok{NA}

\NormalTok{R <-}\StringTok{ }\DecValTok{80}
\NormalTok{P <-}\StringTok{ }\NormalTok{n}\OperatorTok{-}\NormalTok{R}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{P)\{}
\NormalTok{  w <-}\StringTok{ }\NormalTok{y[i}\OperatorTok{:}\NormalTok{(R}\DecValTok{-1}\OperatorTok{+}\NormalTok{i)]}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{average[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(w)}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{naive[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\NormalTok{w[}\KeywordTok{length}\NormalTok{(w)]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt[,}\StringTok{`}\DataTypeTok{:=}\StringTok{`}\NormalTok{(}\DataTypeTok{e_average=}\NormalTok{y}\OperatorTok{-}\NormalTok{average,}\DataTypeTok{e_naive=}\NormalTok{y}\OperatorTok{-}\NormalTok{naive)]}

\NormalTok{rmsfe_average <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_average}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}
\NormalTok{rmsfe_naive <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_naive}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}

\NormalTok{rmsfe_average}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_average}\OperatorTok{~}\DecValTok{1}\NormalTok{,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_naive}\OperatorTok{~}\DecValTok{1}\NormalTok{,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_average}\OperatorTok{~}\NormalTok{average,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_naive}\OperatorTok{~}\NormalTok{naive,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt[,}\StringTok{`}\DataTypeTok{:=}\StringTok{`}\NormalTok{(}\DataTypeTok{e_average.l1=}\KeywordTok{shift}\NormalTok{(e_average),}\DataTypeTok{e_naive.l1=}\KeywordTok{shift}\NormalTok{(e_naive))]}

\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_average}\OperatorTok{~}\NormalTok{e_average.l1,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(e_naive}\OperatorTok{~}\NormalTok{e_naive.l1,}\DataTypeTok{data=}\NormalTok{dt))}\OperatorTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n <-}\StringTok{ }\DecValTok{180}

\KeywordTok{set.seed}\NormalTok{(}\DecValTok{7}\NormalTok{)}
\NormalTok{e <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n,}\DecValTok{0}\NormalTok{,}\DecValTok{4}\NormalTok{)}

\NormalTok{trend <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{n)}

\NormalTok{y <-}\StringTok{ }\DecValTok{10}\FloatTok{+0.01}\OperatorTok{*}\NormalTok{trend}\FloatTok{+0.002}\OperatorTok{*}\NormalTok{trend}\OperatorTok{^}\DecValTok{2}\OperatorTok{+}\NormalTok{e}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt <-}\StringTok{ }\KeywordTok{data.table}\NormalTok{(y,trend)}

\NormalTok{dt}\OperatorTok{$}\NormalTok{date <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2006-01-01"}\NormalTok{),}\DataTypeTok{by=}\StringTok{"month"}\NormalTok{,}\DataTypeTok{along.with=}\NormalTok{y)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ggplot}\NormalTok{(dt,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{date,}\DataTypeTok{y=}\NormalTok{y))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\DecValTok{1}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Year"}\NormalTok{,}\DataTypeTok{y=}\StringTok{"Trending Series"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{AIC_vec <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\DataTypeTok{ncol=}\DecValTok{4}\NormalTok{,}\DataTypeTok{nrow=}\DecValTok{1}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{(i }\OperatorTok{<}\StringTok{ }\DecValTok{4}\NormalTok{)\{}
\NormalTok{    reg <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y}\OperatorTok{~}\KeywordTok{poly}\NormalTok{(trend,}\DataTypeTok{degree=}\NormalTok{i,}\DataTypeTok{raw=}\NormalTok{T),}\DataTypeTok{data=}\NormalTok{dt)}
\NormalTok{    AIC_vec[i] <-}\StringTok{ }\KeywordTok{log}\NormalTok{(}\KeywordTok{crossprod}\NormalTok{(reg}\OperatorTok{$}\NormalTok{residuals))}\OperatorTok{+}\DecValTok{2}\OperatorTok{*}\KeywordTok{length}\NormalTok{(reg}\OperatorTok{$}\NormalTok{coefficients)}\OperatorTok{/}\NormalTok{n}
\NormalTok{  \}}\ControlFlowTok{else}\NormalTok{\{}
\NormalTok{    reg <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{log}\NormalTok{(y)}\OperatorTok{~}\NormalTok{trend,}\DataTypeTok{data=}\NormalTok{dt)}
\NormalTok{    yhat <-}\StringTok{ }\NormalTok{reg}\OperatorTok{$}\NormalTok{fitted.values}
\NormalTok{    sig <-}\StringTok{ }\KeywordTok{sd}\NormalTok{(reg}\OperatorTok{$}\NormalTok{residuals)}
\NormalTok{    ystar <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(yhat}\OperatorTok{+}\NormalTok{sig}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\DecValTok{2}\NormalTok{)}
\NormalTok{    res <-}\StringTok{ }\NormalTok{dt}\OperatorTok{$}\NormalTok{y}\OperatorTok{-}\NormalTok{ystar}
\NormalTok{    AIC_vec[i] <-}\StringTok{ }\KeywordTok{log}\NormalTok{(}\KeywordTok{crossprod}\NormalTok{(res))}\OperatorTok{+}\DecValTok{2}\OperatorTok{*}\KeywordTok{length}\NormalTok{(reg}\OperatorTok{$}\NormalTok{coefficients)}\OperatorTok{/}\NormalTok{n}
\NormalTok{  \}}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt}\OperatorTok{$}\NormalTok{t1 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{dt}\OperatorTok{$}\NormalTok{t2 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{dt}\OperatorTok{$}\NormalTok{t3 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{dt}\OperatorTok{$}\NormalTok{te <-}\StringTok{ }\OtherTok{NA}

\NormalTok{R <-}\StringTok{ }\DecValTok{120}
\NormalTok{P <-}\StringTok{ }\NormalTok{n}\OperatorTok{-}\NormalTok{R}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{P)\{}
\NormalTok{  reg1 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y}\OperatorTok{~}\NormalTok{trend,}\DataTypeTok{data=}\NormalTok{dt[i}\OperatorTok{:}\NormalTok{(R}\DecValTok{-1}\OperatorTok{+}\NormalTok{i)])}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{t1[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\NormalTok{reg1}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{reg1}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{(R}\OperatorTok{+}\NormalTok{i)}
  
\NormalTok{  reg2 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y}\OperatorTok{~}\KeywordTok{poly}\NormalTok{(trend,}\DataTypeTok{degree=}\DecValTok{2}\NormalTok{,}\DataTypeTok{raw=}\NormalTok{T),}\DataTypeTok{data=}\NormalTok{dt[i}\OperatorTok{:}\NormalTok{(R}\DecValTok{-1}\OperatorTok{+}\NormalTok{i)])}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{t2[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\NormalTok{reg2}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{reg2}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{(R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{+}\NormalTok{reg2}\OperatorTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{]}\OperatorTok{*}\NormalTok{((R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
  
\NormalTok{  reg3 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y}\OperatorTok{~}\KeywordTok{poly}\NormalTok{(trend,}\DataTypeTok{degree=}\DecValTok{3}\NormalTok{,}\DataTypeTok{raw=}\NormalTok{T),}\DataTypeTok{data=}\NormalTok{dt[i}\OperatorTok{:}\NormalTok{(R}\DecValTok{-1}\OperatorTok{+}\NormalTok{i)])}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{t3[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\NormalTok{reg3}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{reg3}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{(R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{+}\NormalTok{reg3}\OperatorTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{]}\OperatorTok{*}\NormalTok{((R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{^}\DecValTok{2}\NormalTok{)}\OperatorTok{+}\NormalTok{reg3}\OperatorTok{$}\NormalTok{coef[}\DecValTok{4}\NormalTok{]}\OperatorTok{*}\NormalTok{((R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{^}\DecValTok{3}\NormalTok{)}
  
\NormalTok{  rege <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{log}\NormalTok{(y)}\OperatorTok{~}\NormalTok{trend,}\DataTypeTok{data=}\NormalTok{dt[i}\OperatorTok{:}\NormalTok{(R}\DecValTok{-1}\OperatorTok{+}\NormalTok{i)])}
\NormalTok{  sig <-}\StringTok{ }\KeywordTok{sd}\NormalTok{(rege}\OperatorTok{$}\NormalTok{residuals)}
\NormalTok{  dt}\OperatorTok{$}\NormalTok{te[R}\OperatorTok{+}\NormalTok{i] <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(rege}\OperatorTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{rege}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{(R}\OperatorTok{+}\NormalTok{i)}\OperatorTok{+}\NormalTok{sig}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\DecValTok{2}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt_long <-}\StringTok{ }\KeywordTok{melt}\NormalTok{(dt[,.(date,y,}\DataTypeTok{linear=}\NormalTok{t1,}\DataTypeTok{quadratic=}\NormalTok{t2,}\DataTypeTok{cubic=}\NormalTok{t3,}\DataTypeTok{exponential=}\NormalTok{te)],}\DataTypeTok{id.vars=}\StringTok{"date"}\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(dt_long,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{date,}\DataTypeTok{y=}\NormalTok{value,}\DataTypeTok{color=}\NormalTok{variable))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\DecValTok{1}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T)}\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{values=}\KeywordTok{c}\NormalTok{(}\StringTok{"darkgray"}\NormalTok{,}\StringTok{"black"}\NormalTok{,}\StringTok{"goldenrod"}\NormalTok{,}\StringTok{"steelblue"}\NormalTok{,}\StringTok{"indianred"}\NormalTok{))}\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Year"}\NormalTok{,}\DataTypeTok{y=}\StringTok{"Trending Series and Forecasts"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.title=}\KeywordTok{element_blank}\NormalTok{(),}\DataTypeTok{legend.position=}\KeywordTok{c}\NormalTok{(.}\DecValTok{15}\NormalTok{,.}\DecValTok{85}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt[,}\StringTok{`}\DataTypeTok{:=}\StringTok{`}\NormalTok{(}\DataTypeTok{e_t1=}\NormalTok{y}\OperatorTok{-}\NormalTok{t1,}\DataTypeTok{e_t2=}\NormalTok{y}\OperatorTok{-}\NormalTok{t2,}\DataTypeTok{e_t3=}\NormalTok{y}\OperatorTok{-}\NormalTok{t3,}\DataTypeTok{e_te=}\NormalTok{y}\OperatorTok{-}\NormalTok{te)]}

\NormalTok{rmsfe_t1 <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_t1}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}
\NormalTok{rmsfe_t2 <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_t2}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}
\NormalTok{rmsfe_t3 <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_t3}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}
\NormalTok{rmsfe_te <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean}\NormalTok{(dt}\OperatorTok{$}\NormalTok{e_te}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\NormalTok{T))}
