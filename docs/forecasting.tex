...
Information is key in forecasting. It comes in many forms, and is summarized in \emph{data}. When organized and stored in a certain way -- chronologically and at regular intervals -- we end up with \emph{time series} data. A diverse set of forecasting methods typically rely on insights from econometric analysis of time series data. In time series analysis, the implied assumption is that the past tends to repeat itself, at least to some extent. So, if we well study the past, we may be able to forecast an event with some degree of accuracy.

Accurate forecasting is difficult. Indeed, forecasting is difficult because of all the unknowns we deal with in the process.\footnote{`\emph{As we know, there are known knowns; there are things we know we know. We also know there are known unknowns; that is to say we know there are some things we do not know. But there are also unknown unknowns---the ones we don't know we don't know.}'
  --- Donald Ramsfeld} So, as we forecast, we are bound to make mistakes, which manifest into the \emph{forecast errors}. We have these errors because we don't know the true model (known unknowns), so we make a guess about the most suitable model for time series analysis, leading to \emph{model uncertainty}. We also have the errors because we don't know the true parameters of the model (unknown knowns). Instead, using a subset of history we estimate the parameters, which are prone to a sampling error due to \emph{parameter uncertainty}. Finally, even if were to perfectly guess the true model, and even if we were to generate precise parameter estimates, our forecasts may still be off because of \emph{temporal uncertainty} for all those factors that have never happened in the past, and only characterize the future (unknown unknowns).
...
\addcontentsline{toc}{chapter}{Tutorial 2: Data Management}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-59-1.pdf}
...
\addcontentsline{toc}{chapter}{Tutorial 4: Trends and Seasonality}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-64-1.pdf}
...
\addcontentsline{toc}{chapter}{Tutorial 5: Autoregressive Models}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-72-1.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-73-1.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-73-2.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-77-1.pdf}
...
\addcontentsline{toc}{chapter}{Tutorial 6: Vector Autoregressive Models}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-81-1.pdf}
...
\addcontentsline{toc}{chapter}{Tutorial 7: Dynamic Factor Models}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-89-1.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-94-1.pdf}
...
\includegraphics{forecasting_files/figure-latex/unnamed-chunk-97-1.pdf}
