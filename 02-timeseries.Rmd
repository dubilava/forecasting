...
```{r white-noise, fig.cap="White noise process", echo=FALSE, message=FALSE}
n <- 132
...
ggplot(dt,aes(x=k,y=rho))+
  geom_segment(aes(xend=k,yend=0),size=1.2,col="darkgray")+
...
```{r dji, fig.cap="Dow Jones Industrial Average", echo=FALSE, message=FALSE}
