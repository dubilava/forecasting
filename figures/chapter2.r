...
gg_stationary <- ggdraw(aligned_plots[[1]]) + 
  ...
  draw_plot(aligned_plots[[1]],x=2/6+0.002,y=0,width=1,height=1) + 
  draw_plot(aligned_plots[[1]],x=3/6+0.003,y=0,width=1,height=1) + 
  draw_plot(aligned_plots[[1]],x=4/6+0.004,y=0,width=1,height=1) + 
...
gg_nonstationary <- ggdraw(aligned_plots[[1]]) + 
  ...
  draw_plot(aligned_plots[[3]],x=2/6+0.002,y=0,width=1,height=1) + 
  draw_plot(aligned_plots[[4]],x=3/6+0.003,y=0,width=1,height=1) + 
  draw_plot(aligned_plots[[5]],x=4/6+0.004,y=0,width=1,height=1) + 
